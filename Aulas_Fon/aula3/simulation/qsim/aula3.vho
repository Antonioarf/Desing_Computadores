...
SIGNAL \nomeComponente|saida[1]~1_combout\ : std_logic;
SIGNAL \nomeComponente|saida[2]~2_combout\ : std_logic;
...
SIGNAL \nomeComponente|saida[0]~0_combout\ : std_logic;
...
SIGNAL \nomeComponente|ALT_INV_saida[1]~1_combout\ : std_logic;
...
\nomeComponente|ALT_INV_saida[1]~1_combout\ <= NOT \nomeComponente|saida[1]~1_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \nomeComponente|saida[0]~0_combout\,
	devoe => ww_devoe,
	o => \LEDR[6]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \nomeComponente|saida[2]~2_combout\,
	devoe => ww_devoe,
	o => \LEDR[8]~output_o\);
...
\nomeComponente|saida[1]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \nomeComponente|saida[1]~1_combout\ = (!\PC|DOUT\(0) & (!\PC|DOUT\(1) & !\PC|DOUT\(2)))
...
\nomeComponente|saida[2]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \nomeComponente|saida[2]~2_combout\ = !\PC|DOUT\(2) $ (((!\PC|DOUT\(0) & !\PC|DOUT\(1))))
...
PORT MAP (
	...
	clrn => \nomeComponente|ALT_INV_saida[1]~1_combout\,
	ena => \nomeComponente|saida[2]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \REGA|DOUT\(0));
...
\nomeComponente|saida[0]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \nomeComponente|saida[0]~0_combout\ = (!\PC|DOUT\(2) & ((\PC|DOUT\(1)) # (\PC|DOUT\(0))))
